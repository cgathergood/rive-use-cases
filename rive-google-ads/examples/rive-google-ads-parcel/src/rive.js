...
k.onRuntimeInitialized = function() {
  ...
  function b(q) {
    var u = {alpha:!0, depth:!1, stencil:!1, antialias:!1, premultipliedAlpha:!0, preserveDrawingBuffer:0, powerPreference:"high-performance", failIfMajorPerformanceCaveat:0, enableExtensionsByDefault:!1, explicitSwapControl:0, renderViaOffscreenBackBuffer:0,}, y = q.getContext("webgl2", u);
    if (!y) {
      return null;
    }
    u = ia(y, u);
...
}, 528361:() => void 0 !== navigator.mediaDevices && void 0 !== navigator.mediaDevices.getUserMedia, 528465:() => {
  try {
...
}, 531513:a => window.h.va(a).J.sampleRate, 531586:a => {
  a = window.h.va(a);
...
k.___start_em_js = 523124;
k.___stop_em_js = 525879;
var Zd;
Ha = function $d() {
  Zd || ae();
  Zd || (Ha = $d);
